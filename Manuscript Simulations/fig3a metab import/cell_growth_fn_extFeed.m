function bac = cell_growth_fn_extFeed(n,p,T,Sin,clock, sec_or_min, cell_rec, child, config, createRec, threshold, same_thresh, t_on, t_off, n_ext, feed_rate) 	
