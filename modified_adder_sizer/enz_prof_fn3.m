...
% Function assumes that all the enzymes are on the same operon and thus creates a single stochastic profile
function var = enz_prof_fn3(n,p,T,gene_seqlen,speed_transcription,t_on,t_off, prot_seqlen, speed_translation, clock, extend, prev_cell_dat, singOper)
